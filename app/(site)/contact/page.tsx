...
export default async function ContactPage(props: PageProps<"/contact">) {
  ...
  return (
    <>
      {/* 2026-09-24: "move the form to the hero section, and map below it".
          Every "Ask about ..." button lands here with its topic chosen, so the
          form is the first thing on the page. */}
      <PageHero
        eyebrow="Contact"
        ...
        aside={
          <div id="enquiry" className="scroll-mt-24">
            <h2 className="display mb-5 text-sub">{form.heading}</h2>
            <EnquiryForm
